...
if __name__== "__main__":
    ...
    for series_length in [2,3,4,5,8]:
        ...
        # Simple model
        model_1 = Sequential()
        model_1.add(LSTM(32, input_shape=(series_length, 57), dropout=0.6, recurrent_dropout=0.4))
        model_1.add(Dense(n_outputs, activation='softmax'))
        model_1.compile(optimizer='adam', loss='categorical_crossentropy',metrics=['accuracy'] )

        # Deeper model
        model_2 = Sequential()
        model_2.add(LSTM(100, input_shape=(series_length, 57), return_sequences=True, dropout=0.6, recurrent_dropout=0.4))
        ...
        # Bidirectional model
        model_3 = Sequential()
        model_3.add(Bidirectional(LSTM(32, dropout=0.6, recurrent_dropout=0.4), input_shape=(series_length, 57)))
