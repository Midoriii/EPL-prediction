...
for p in range(1,12):
    col_names_features_ablation.remove('home_player_' + str(p))
    col_names_features_ablation.remove('away_player_' + str(p))
    col_names_features_ablation.remove('home_player_' + str(p) + "_last5")
    col_names_features_ablation.remove('away_player_' + str(p) + "_last5")
...
with open('eval/ablation_results.txt', "a+") as f:
    f.write("Without Players: " + str(sum(results_ablated) / 50) + "\n")

print("All feats: " + str(sum(results_all_feats) / 50))
print("Without features: " + str(sum(results_ablated) / 50))
